...
export default function SignUpAccount() {
  const { control, resetField, watch } = useFormContext<SignUpFormValues>(); // 상위 RHF 제공자(Provider) 구독
    ...
    <>
      <View className="gap-4">
        ...
        <PasswordConfirmInputField
          control={{ name: "account.passwordConfirm", control }}
          resetField={resetField}
          watch={watch}
          confirmTarget="account.password"
        />
      </View>
